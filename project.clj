(defproject ghostandthemachine.com "0.1.0-SNAPSHOT"
  :description "FIXME: write description"
  :url "http://example.com/FIXME"
  :license {:name "Eclipse Public License"
            :url "http://www.eclipse.org/legal/epl-v10.html"}
  :main ghostandthemachine.com.main
  :aot [ghostandthemachine.com.main]
  :uberjar-name "ghostandthemachine.com-standalone.jar"
